...
smoothened_list, headers_smoothened=calculate_smoothened_values_pandaless(1907675,list(cases_dict.values()),list(cases_dict.keys()),list_of_tests=list(tests_dict.values()))
